...
namespace EMCR.Utilities.Caching
{
    internal class Cache : ICache
    {
        ...
        public Cache(IDistributedCache cache, CacheSyncManager cacheSyncManager, ILogger<Cache> logger)
        {
            this.cache = cache;
            this.cacheSyncManager = cacheSyncManager;
            this.logger = logger;
            this.keyPrefix = Environment.GetEnvironmentVariable("APP_NAME") ?? string.Empty;
        }
