...
#pragma warning disable CS8604 // Possible null reference argument.
            CreateMap<ProgressReportDetails, drr_projectprogress>(MemberList.None)
                ...
                .ForMember(dest => dest.drr_communitymediaannouncements, opt => opt.MapFrom(src => src.Workplan.MediaAnnouncement.HasValue ? src.Workplan.MediaAnnouncement.Value ? (int?)DRRTwoOptions.Yes : (int?)DRRTwoOptions.No : null))
                ...
                .ForPath(dest => dest.Workplan.MediaAnnouncement, opt => opt.MapFrom(src => src.drr_communitymediaannouncements.HasValue ? src.drr_communitymediaannouncements.Value == (int)DRRTwoOptions.Yes : (bool?)null))
