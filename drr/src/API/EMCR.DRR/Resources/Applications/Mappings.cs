...
#pragma warning disable CS8629 // Nullable value type may be null.
            CreateMap<Application, drr_application>(MemberList.None)
                ...
                .ForMember(dest => dest.ProposedActivities, opt => opt.Ignore())
                .ForMember(dest => dest.VerificationMethods, opt => opt.Ignore())
                .ForMember(dest => dest.VerificationMethodsComments, opt => opt.Ignore())
                .ForMember(dest => dest.ProjectAlternateOptions, opt => opt.Ignore())
                .ForMember(dest => dest.FirstNationsEngagementComments, opt => opt.Ignore())
                .ForMember(dest => dest.OtherEngagement, opt => opt.Ignore())
                .ForMember(dest => dest.AffectedParties, opt => opt.Ignore())
                .ForMember(dest => dest.OtherEngagementComments, opt => opt.Ignore())
                .ForMember(dest => dest.CollaborationComments, opt => opt.Ignore())
                .ForMember(dest => dest.ClimateAdaptationScreener, opt => opt.Ignore())
                .ForMember(dest => dest.PublicBenefit, opt => opt.Ignore())
                .ForMember(dest => dest.ComplexityRiskMitigated, opt => opt.Ignore())
                .ForMember(dest => dest.ComplexityRisks, opt => opt.Ignore())
                .ForMember(dest => dest.ComplexityRiskComments, opt => opt.Ignore())
                .ForMember(dest => dest.ReadinessRiskMitigated, opt => opt.Ignore())
                .ForMember(dest => dest.ReadinessRisks, opt => opt.Ignore())
                .ForMember(dest => dest.ReadinessRiskComments, opt => opt.Ignore())
                .ForMember(dest => dest.SensitivityRiskMitigated, opt => opt.Ignore())
                .ForMember(dest => dest.SensitivityRisks, opt => opt.Ignore())
                .ForMember(dest => dest.SensitivityRiskComments, opt => opt.Ignore())
                .ForMember(dest => dest.CapacityRiskMitigated, opt => opt.Ignore())
                .ForMember(dest => dest.CapacityRisks, opt => opt.Ignore())
                .ForMember(dest => dest.CapacityRiskComments, opt => opt.Ignore())
                .ForMember(dest => dest.RiskTransferMigigated, opt => opt.Ignore())
                .ForMember(dest => dest.TransferRisks, opt => opt.Ignore())
                .ForMember(dest => dest.TransferRisksComments, opt => opt.Ignore())
                .ForMember(dest => dest.YearOverYearFunding, opt => opt.Ignore())
                .ForMember(dest => dest.TotalDrifFundingRequest, opt => opt.Ignore())
                .ForMember(dest => dest.DiscrepancyComment, opt => opt.Ignore())
            ;
